...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> { const paper = getPaperBySlug((await params).slug); return paper ? { title: paper.title, description: paper.excerpt } : {}; }
