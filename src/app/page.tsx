...
export default function Home() {
  ...
  return <>
    ...
    <PageContainer>
      <section className="homepage-introduction manifesto-preview section-rule"><div><p className="eyebrow">A public archive of clear thinking</p><h2>The permanent home for ideas before they become products.</h2></div><div><p>The Teff Papers is a long-term public journal where I document my thinking across artificial intelligence, personal digital intelligence, automation, systems thinking, blockchain, faith, leadership, technology, and human behaviour.</p><p>This is not a blog built for noise. It is where ideas are captured, refined, and preserved before they become products, companies, research, books, or something bigger.</p><p>It is a body of work.</p></div></section>
